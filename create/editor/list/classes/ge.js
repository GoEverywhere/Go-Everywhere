    ...
    initialize : function(container){
        ...
        $(container).html(
            ...
            '<div id="dialogs">' +
                ...
                '<div id="newCustomBlockDialog" title="New Block" class="nowrap" ondialogcancel="$(\'#blockDesigner\').children().children().val(\'\').not(\':first\').remove();" ondialogok="var tmpLabel = \'\', tmpVarNames = [], tmpDefaults = [], tmpAtomic = $(\'#isCustomAtomic\').prop(\'checked\'); $(\'#blockDesigner\').children().children().each(function(){ if($(this).hasClass(\'label\')) { tmpLabel += $(this).val() + \' \'; }else if($(this).hasClass(\'string\')){ tmpLabel += \' %s \'; tmpVarNames.push($(this).val()); tmpDefaults.push(\'\'); }else if($(this).hasClass(\'number\')){ tmpLabel += \' %n \'; tmpVarNames.push($(this).val()); tmpDefaults.push(1); }else if($(this).hasClass(\'boolean\')){ tmpLabel += \' %b \'; tmpVarNames.push($(this).val()); tmpDefaults.push(false); } }); ge.editor.parser.saveCurrentObjectInJSON(); ge.editor.currentObj.scripts.push([0, 0, [[\'procDef\', tmpLabel, tmpVarNames, tmpDefaults, tmpAtomic]]]); ge.editor.loadCurrentSelectedSprite();">' +
                    ...
                    '<span>' +
                        ...
                        'Add text input: <div class="button" id="addLabelToDeclaration" onclick="$(\'#blockDesigner\').children().append(\'<input class=\\\'string\\\' length=\\\'5\\\' type=\\\'text\\\' />\');"><div style="background-color: gray;width: 40px; height: 20px;"></div></div><br />' +
                        'Add boolean input: <div class="button" id="addLabelToDeclaration" onclick="$(\'#blockDesigner\').children().append(\'<input class=\\\'boolean custom\\\' length=\\\'5\\\' type=\\\'text\\\' />\');"><div class="boolean-shape"><div class="triangle-left"></div><div style="width: 20px;height: 20px;background-color: gray;"></div><div class="triangle-right"></div></div></div><br />' +
