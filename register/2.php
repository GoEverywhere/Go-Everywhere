...
if(empty($_POST['username']))
{
	...
	echo '<p>Please go to the <a href="' . $project_url . '#comments" target="_BLANK">user verification project</a> and comment the following code: <input type="text" readonly="true" length="40" value="' . $user_code . '" /></p>';
